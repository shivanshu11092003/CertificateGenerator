...
const Deleted = () => {
    ...
    return (
        isLoading ? <Loader /> : <div className='h-full border-x-2 w-full'>
            <div className='flex justify-between py-3 px-6  mt-3'>
                <div className='flex  font-bold text-xl ' >Trash</div>
                    ...
                    file.map((item, index) =>
                        ...
                        <div key={index} className='flex group   p-1 m-1 flex-col justify-between 
                            ...
                            <div className='flex justify-center items-center' >
                                {
                                    item.type == 'zip' ? <div className='flex self-start' >
